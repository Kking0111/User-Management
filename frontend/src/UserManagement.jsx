...
function UserManagement() {
  ...
  const fetchUsers = async () => {
    ...
    setError(null);
    try {
      const res = await axios.get('http://44.223.17.124:3000/api/users');
      setUsers(res.data);
    } catch (err) {
  ...
  const handleAddUser = async (e) => {
    ...
    setError(null);
    try {
      await axios.post('http://44.223.17.124:3000/api/users', form);
  ...
  const handleUpdateUser = async (e) => {
    ...
    setError(null);
    try {
      await axios.put(`http://44.223.17.124:3000/api/users/${editingUserId}`, form);
  ...
  const handleDeleteUser = async (id) => {
    ...
    setError(null);
    try {
      await axios.delete(`http://44.223.17.124:3000/api/users/${id}`);
      fetchUsers();
    } catch (err) {
